...
class CustomAttributes(widget_base.WidgetAdminCustomAttributes):
  ...
  def get_items_list(self):
    ...
    return self.ca_tree_view.get_tree_view_items()

  def add_custom_attribute(self, ca_object):
    """Add a Custom Attribute from CustomAttribute object given."""
    ca_dropdown = self.expand_collapse_group(ca_object.definition_type,
                                             expand=True)
    ca_dropdown.add_new_custom_attribute(ca_object)
  ...
  def get_custom_attributes_list(self, ca_group):
    ...
    ca_dropdown = self.expand_collapse_group(ca_group, expand=True)
    return ca_dropdown.get_custom_attributes_list()
